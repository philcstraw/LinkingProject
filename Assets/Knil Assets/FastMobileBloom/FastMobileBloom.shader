...
fixed4 fragCombineBloom(v2fCombineBloom i) : SV_Target
{
	...
	return tex2D(_BloomTex, i.uv) * _BloomIntensity;
#else
...
fixed4 fragCombineTextures(v2fCombineBloom i) : SV_Target
{
#if UNITY_UV_STARTS_AT_TOP
	fixed4 col = tex2D(_MainTex,  i.uv2);
...
ENDCG
			...
			Pass
		{
			CGPROGRAM
#pragma vertex vertCombineBloom
#pragma fragment fragCombineTextures
			ENDCG
		}
	}
}